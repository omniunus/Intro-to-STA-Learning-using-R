...
```{r}
vec1+vec2
vec1*5 # every elements *5
vec1^2
vec1/vec2
```
3. relational operators: produces logical statements
```{r}
vec1<vec2 # comparing each element correspondingly
vec1>1 # comparing each element with 1
```
4. logical operators: & | !
```{r}
a = 1
b = 2
c = F
a>1 | b <2 # either one of the conditions on the left and right fit the condition would return true
a>0 & b <3 # both have to meet the requirement to be true
!c
```
